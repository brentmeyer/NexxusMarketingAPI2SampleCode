...
namespace FindMerge {
    /// <summary>
    /// Class to create Resource objects from Bulk Find results (multiple rows of PSVs)
    /// </summary>
    public static class Hydrate {
        ...
        /// <summary>
        /// Hydrates a single resource from a Bulk Find operation
        /// </summary>
        /// <param name="result"></param>
        /// <returns></returns>
        public static Resource HydrateBulkResource(String result) {
            Resource resource = null;
